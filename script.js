...
function calcFees() {
    ...
    if (selectInstallment.value == "2") {
        ...
        <strong>R$ ${result2.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "3") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result3.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "4") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result4.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "5") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result5.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "6") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result6.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "7") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result7.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "8") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result8.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "9") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result9.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "10") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result10.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "11") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result11.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "12") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result12.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "13") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result13.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "14") {
        ...
        <strong>R$ ${result14.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "15") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result15.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "16") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result16.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "17") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result17.toFixed(2) / selectInstallment.value}</strong></p>`
    }
    if (selectInstallment.value == "18") {
        ...
        em <strong>${selectInstallment.value} </strong>parcelas<br> de 
        <strong>R$ ${result18.toFixed(2) / selectInstallment.value}</strong></p>`
    }
}
